...
namespace SurveyApp.Infrastructure.Data
{
    public class SurveyAppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                // Provide your SQL Server connection string here
                optionsBuilder.UseSqlServer("Server=localhost;Database=SurveyAppDb;TrustServerCertificate=True;Trusted_Connection=True;");
            }
        }
